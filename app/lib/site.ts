...
export const siteConfig = {
  ...
  credentials: {
    ...
    mldCertification: "CMLDT #KTM0325TX01",
    practicingSince: "2013",
  },
  contact: {
    email: "relax@bodyworksbyelony.com",
    phone: "512-535-0096",
    phoneHref: "tel:+15125350096",
    text: "888-282-9032",
    textHref: "sms:+18882829032",
  },
  location: {
    city: "Cedar Park, TX",
    zip: "78613",
    landmark: "N Lakeline Blvd & W Whitestone Blvd",
    serviceArea: "Cedar Park, Leander, northwest Austin, and Liberty Hill",
